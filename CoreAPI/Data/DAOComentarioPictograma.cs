...
namespace Data {
    ...
    public class DAOComentarioPictograma {
        ...
        private UComentarioPictograma comentario;
         ...
         * Retorna: True si la inserción se hizo de forma correcta - False si ocurre un error durante la ejecución del método
         */
        public bool ActualizarComentario(UComentarioPictograma comentario) {

            this.comentario = new UComentarioPictograma();

            using (this.dataBase) {

                this.comentario = this.dataBase.ComentarioPictograma.Where(
        ...
        public bool BorrarComentario(long id) {
            ...
            using (this.dataBase) {
                ...
                this.comentario = this.dataBase.ComentarioPictograma.Find(id);
                this.dataBase.ComentarioPictograma.Remove(this.comentario);
                this.dataBase.SaveChanges();
                return true;
            }
        }
